...
import { Calendar, Clock, Loader2, Play, ShieldCheck, Video } from "lucide-react";
import { apiRequest } from "@/lib/api";

type LiveClass = { id: string; title: string; teacherName: string; scheduledStart: string; scheduledEnd: string; status: "SCHEDULED" | "LIVE"; batchName: string; courseName: string };
