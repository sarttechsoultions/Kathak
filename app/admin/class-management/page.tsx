...
export default function AdminLiveClassespage() {
  ...
  const fetchClasses = useCallback(async () => {
    try {
      const res = await apiRequest<{ status: string; data: { classes: LiveClass[] } }>(ENDPOINTS.ADMIN_CLASSES);
    ...
    <div className="min-h-screen bg-white p-6 lg:p-8 font-sans flex justify-center">
      <div className="w-full max-w-[1200px] mx-auto">
        ...
        <div className="w-full flex flex-col sm:flex-row sm:items-end justify-between border-b border-stone-200 pb-4 mb-8 gap-4">
          ...
          <Link
            href="/admin/class-management/schedule"
            className="shrink-0 bg-[#9B3434] hover:bg-[#832c2c] text-white px-6 py-3 rounded-xl font-bold text-[14px] transition-colors shadow-md shadow-[#9B3434]/20 flex items-center gap-2"
          >
